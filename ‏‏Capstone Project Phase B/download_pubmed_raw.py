...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec  9 10:15:20 2024
...
def generate_article_titles(dataset, output_dir='data/OurResearch/', filename='article_titles_with_date.txt'):
    ...
    with open(output_path, 'a', encoding='utf-8') as f:
        for i in range(1, data.num_nodes):  # Skip 0 ID
            pmid = str(i)
            try:
...
def main():
    ...
    generate_article_titles(dataset, output_dir='data/OurResearch/', filename='article_titles_with_date.txt')
